...
5. Download the full Excel report or flagged-items-only report
...
| Cat 4 - Odd Size | Raw Size is in bottom 25th percentile of 12mo sales for its category (Wheel/Tire calculated separately as their sizes are different btw these two classes - tool is going to take care of it) |
